...
if __name__ == '__main__':
    ...
    body = simpledialog.askstring(title=window, prompt="Enter a body part")
    ...
    messagebox.showinfo(message="Piranhas are more " +adjective+ " during the day, so cross the river at night. Piranhas are attracted to fresh "+liquid+" and will most likely take a bite out of your "+body+" if you "+verb+". Whatever you do, if you have an open wound, try to find another way to get back to the " +place+". Good luck!")
