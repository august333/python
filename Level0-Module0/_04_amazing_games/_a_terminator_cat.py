...
if __name__ == '__main__':
    ...
    set_background(filename='bigEyedCat2.gif')
    # 3. Make a new turtle
    turtle_six = turtle.Turtle()
    ...
    #    and initialize them:
left_eye = Eye(eye=turtle_six, x=4, y=56, radius=7)
right_eye = Eye(eye=turtle_six, x=-51, y=59, radius=7)
