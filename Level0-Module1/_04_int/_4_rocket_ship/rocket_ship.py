...
def mouse_pressed(event):
    ...
    canvas.create_oval(451, 473, 473, 451, fill='yellow', width=1)
    canvas.create_oval(373, 433, 433, 373, fill='orange', width=1)
    canvas.create_oval(201, 100, 100, 201, fill='red', width=1)
