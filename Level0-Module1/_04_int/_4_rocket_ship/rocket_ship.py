...
def mouse_pressed(event):
    ...
    points = [x - 13, y + 13, x + 13, y - 13]
    canvas.create_oval(points, fill='yellow', width=1)

    points = [x - 63, y + 63, x + 63, y - 63]
    canvas.create_oval(points, fill='orange', width=3)

    points = [x - 93, y + 93, x + 93, x - 93]
